...
- **Hand out to several characters at once.** The 📜 button in the table toolbar opens a hand-out dialog: pick a handout, tick any mix of characters (with **All** / **None**), and give it to all of them in one go. Anyone who already holds it is shown ticked and locked, so you are always adding rather than replacing.
