...
function addWeapon() {
  ...
  tr.innerHTML = `<td><input type="text" placeholder="Name"></td><td><div style="display:flex;align-items:center;gap:2px"><input type="text" value="+0" style="width:46px"><button class="roll-btn" onclick="rollWeaponAtk(this)" title="Roll attack"><svg class="lt-icon" aria-hidden="true" focusable="false"><use href="#i-dice"></use></svg></button></div></td><td><div style="display:flex;align-items:center;gap:2px"><input type="text" placeholder="1d6 slashing"><button class="roll-btn" onclick="rollWeaponDmg(this)" title="Roll damage"><svg class="lt-icon" aria-hidden="true" focusable="false"><use href="#i-dice"></use></svg></button></div></td><td><input type="text" placeholder="Notes"></td><td><button class="del-btn" onclick="delRow(this)"><svg class="lt-icon" aria-hidden="true" focusable="false"><use href="#i-close"></use></svg></button></td>`;
  tbl.appendChild(tr);
